...
// police workspace: the Watch Commander's board — each ask routes through our own
// /plan, /predict and /scenario endpoints and drives the same map (BCU-level moves).
const POLICE_QUICK_ASKS = [
  "How many officers do we relocate next month, and from where?",
  "What's the forecast for Southwark next month?",
  "Where should we send units around Hackney?",
  "What happens if we close Croydon police station?",
  "Crime outlook for Westminster next month",
  "Forecast for Tower Hamlets next month",
];
